...
class Flocker040 < Formula
  ...
  url "https://storage.googleapis.com/archive.clusterhq.com/downloads/flocker/Flocker-0.4.0.tar.gz"
  sha1 "ca63eaf640713c5f64a9cea83671970ff70487fd"
  ...
  resource "websocket-client" do
    ...
    sha1 "1a18ee13697afe9d330a587d0c5e2a87aec6acef"
  end
