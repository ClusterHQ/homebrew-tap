...
class Flocker033dev7 < Formula
  homepage "https://clusterhq.com"
  url "https://storage.googleapis.com/archive.clusterhq.com/downloads/flocker/Flocker-0.3.3dev7.tar.gz"
  sha1 "b4ed2e38bc4142eec14a4705ead62165fb29162a"
  ...
  resource "pyrsistent" do
    url "https://pypi.python.org/packages/source/p/pyrsistent/pyrsistent-0.7.0.tar.gz"
    sha1 "0df286bdcda27bacd67321154c7e74c48e3ba43b"
  end
  ...
  resource "websocket-client" do
    url "https://pypi.python.org/packages/source/w/websocket-client/websocket-client-0.25.0.tar.gz"
    sha1 "afed8bb62c2761f6fd695918d18eddc790416166"
  end
