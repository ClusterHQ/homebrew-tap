...
class Flocker140Dev2 < Formula
  homepage "https://clusterhq.com"
  url "https://clusterhq-archive.s3.amazonaws.com/python/Flocker-1.4.0.dev2.tar.gz"
  sha1 "cadaf86d3c135b3144c321b814218253379693b3"
